...
package com.putao.ptx.wirelesstransfer.server;

import android.util.Log;

import com.putao.ptx.wirelesstransfer.FsSettings;
import com.putao.ptx.wirelesstransfer.Util;
...
public class CmdPASS extends FtpCmd implements Runnable {
    ...
    public void run() {
        ...
        if (username == null || password == null) {
            ...
            sessionThread.writeString("230 anonymous login ok, granted read and writing.\r\n");
            Log.i(TAG, "Guest logged in with email: " + attemptPassword);
            sessionThread.authAttempt(true);//always allow, victor added
        } else {
